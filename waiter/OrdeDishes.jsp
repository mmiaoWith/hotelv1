...
%>
<input type="text" name="phone" readonly="readonly" value=<%=session.getAttribute("cGuest")%>>
<br>
<form action=""></form>
...
while(rst.next()){%>
<tr>
<td align="center" id="did"><%=rst.getInt(1) %></td>
<td align="center"><%=rst.getString(2) %></td>
<td align="center" id="price"><%=rst.getString(3) %></td>
<td align="center"><a href="ODmiddle.jsp?did=<%=rst.getInt(1)%>">点餐</a></td>
</tr>
<%} %>
</table><p>
<%
